...
namespace Onana_Hospital_Management_System
{
    public partial class frmLogin : Form
    {
        ...
        private void frmLogin_Load(object sender, EventArgs e)
        {
            ...
            notifyIcon1.ShowBalloonTip(5000, "Acknowledgement", "A product from Okyere Michael", ToolTipIcon.Info);
         ...
         void Logins(string Usernames, string Password, ComboBox comLevel)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Invalid Username or Password or Privilege", "Error ", MessageBoxButtons.OK, MessageBoxIcon.Error);
