...
namespace Onana_Hospital_Management_System
{
    public partial class frmParent : Form
    {
        ...
        private void wardToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            frmWard he = new frmWard();
            he.Show();
        }
        ...
        {
            this.Close();
            frmLogin hj = new frmLogin();
            hj.Show();
        }

        private void patientBillsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmPatientBills kk = new frmPatientBills();
            kk.ShowDialog();
        }
    }
}
