    ...
    public partial class frmPayments : Form
    {
     ...
     // string dbPath = @"Data Source=SONY\MSSQLSERVER00V1;Initial Catalog=dbOHMS;Integrated Security=True";
            ...
            try
            {
                if (txtPatID.Text.Trim() != "")
                {
                    if (txtAmt.Text == "0")
                    {
                        ...
                        MessageBox.Show("Patient owes nothing", "Save Data ", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        return;
                    }
                    else
                    {
       ...
       int  StartYpos= 0;
        ...
        e.Graphics.DrawString("MICHAEL HOSPITAL MANAGEMENT SYSTEM" + Environment.NewLine, pfont, Brushes.Black, StartXpos, StartYpos);
        e.Graphics.DrawString("P.O.BOX 1 OFFINSO-NSUONTEM, Tel: 055 382 8805" + Environment.NewLine, new Font("Comic Sans MS", 9), Brushes.Black, 0, 30);
