    ...
    public partial class frmProduct : Form
    {
       ...
       clsUpdate theUpdates = new clsUpdate();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            validateItemLoc(txtItemLocation);
               ...
               else
               {
                   ...
                   {
                       MessageBox.Show("Item is Expire", "Expire Product ", MessageBoxButtons.OK, MessageBoxIcon.Error);
                       return;
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Item Number", "Error ", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
        ...
        private void btnSell_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                MessageBox.Show("Invalid Patient ID", "Error ", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
        ...
        void ProcessInput()
        {
            ...
            if (proQty < 0)
            { 
                 MessageBox.Show("Qty instock is less qty requested", "Save Data ", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                 return;
            }
        ...
        void updateProduct()
        {
            ...
            try
            {
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("Product updated successfully ", "Save Data ", MessageBoxButtons.OK, MessageBoxIcon.Information);
                con.Close();
            }
            catch (Exception ex)
            {
